...
export default async function EditDispatchPage({
  ...
  const defaultValues: DispatchFormValues = {
    ...
    weight_ton: dispatch.weight_ton ?? undefined,
    ...
    source_major: dispatch.source_major ?? "",
    source_minor: dispatch.source_minor ?? "",
    source_note: dispatch.source_note ?? "",
    supply_amount: dispatch.supply_amount,
